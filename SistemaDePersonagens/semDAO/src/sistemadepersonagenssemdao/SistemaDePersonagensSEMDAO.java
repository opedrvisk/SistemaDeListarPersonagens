 ...
 */
package sistemadepersonagenssemdao;
 ...
 * @author Pedrovisk
 */
public class SistemaDePersonagensSEMDAO {

public static void main(String[] args) {

        Scanner entrada = new Scanner(System.in);

        System.out.println("Bem vindo ao cadastro de personagens! \n O que voce gostaria de fazer? \n 1)Cadastrar\n 2)Deletar\n 3)Atualizar\n 4)Consultar um personagem\n 5)Consultar lista completa");
        ...
        if (escolha == 1) {
            ...
            entrada.nextLine();
            System.out.println("Qual personagem voce quer apagar? ");
            ...
            try {
                List<Personagens> personagens = p.consultarLista();
                if (personagens.isEmpty()) {
                    ...
                    for (Personagens personagem : personagens) {
                        ...
                        System.out.println("Descricao do personagem: " + personagem.getDescricao());
                        System.out.println("Avaliacao do personagem: " + personagem.getAvaliacao());
                        System.out.println("-----------------------------");
                    }
                }
            } catch (SQLException | ClassNotFoundException ex) {
            ...
            System.out.println("Opção invaliida. Tente novamente.");
        }
    }
}